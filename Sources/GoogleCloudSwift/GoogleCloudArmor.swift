...
// MARK: - Cloud Cloud Armor Templates

/// Pre-configured Cloud Armor templates for Cloud deployments
public enum CloudArmorTemplate {
    ...
    public static func securityPolicy(
        ...
        GoogleCloudSecurityPolicy(
            ...
            projectID: projectID,
            description: "Security policy for \(deploymentName) Cloud deployment",
            type: .cloudArmor,
            ...
            labels: ["deployment": deploymentName, "managed-by": "googlecloudswift"]
        )
    }
    ...
    /// Complete setup script for Cloud deployment
    public static func setupScript(
        ...
        # Cloud Cloud Armor Setup Script
        # Project: \(projectID)
    ...
    public static func teardownScript(
        ...
        # Cloud Cloud Armor Teardown Script
    ...
    public static func policyYAML(
        ...
        name: \(deploymentName)-security-policy
        description: "Comprehensive security policy for \(deploymentName) Cloud deployment"
