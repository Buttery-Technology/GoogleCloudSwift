...
// MARK: - Cloud Cloud Run Templates

/// Predefined Cloud Run configurations for Cloud.
public enum CloudRunTemplate {
    ...
    public static func grpcService(
        ...
        GoogleCloudRunService(
            ...
            description: "Cloud gRPC service for \(deploymentName)"
        )
    }
    ...
    public static func httpAPI(
        ...
        GoogleCloudRunService(
            ...
            description: "Cloud HTTP API for \(deploymentName)"
        )
    }

    /// Cloud worker service (background processing)
    public static func worker(
        ...
        GoogleCloudRunService(
            ...
            description: "Cloud background worker for \(deploymentName)"
        )
    }
    ...
    /// Generate setup script for Cloud Cloud Run deployment
    public static func setupScript(
        ...
        echo "========================================"
        echo "Cloud Cloud Run Deployment"
        echo "========================================"
    ...
    /// Generate Dockerfile for Cloud service
    ...
    public static func cloudbuildConfig(
        ...
        """
        # Cloud Build configuration for Cloud
        # Generated by GoogleCloudSwift
